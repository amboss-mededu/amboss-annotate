...
class Anchor extends HTMLElement {
  ...
  render() {
    ...
    if (this.content === null) {
      console.error('this.content is null. You may need to create the <amboss-content /> element in the dom')
    }
  ...
  create() {
    ...
    this.popperInstance = createPopper(this.target, this.content, getPopperOptions(arrow))
  }
